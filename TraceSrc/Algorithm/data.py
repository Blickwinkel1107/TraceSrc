...
allVertices = [
    {"id": 1, "label": 'V1供货商A', "class": 'type-suss'},
    {"id": 2, "label": 'V2供货商B', "class": 'type-suss'},
    {"id": 3, "label": 'V3供货商C', "class": 'type-init'},
    {"id": 4, "label": 'V4供货商D', "class": 'type-ready'},
    {"id": 5, "label": 'V5供货商E', "class": 'type-fail'},
    {"id": 6, "label": 'V6供货商F', "class": 'type-suss'},
    {"id": 7, "label": 'V7供货商G', "class": 'type-suss'},
    {"id": 8, "label": 'V8供货商H', "class": 'type-freeze'},
    {"id": 9, "label": 'V9供货商I', "class": 'type-suss'},
    {"id": 10, "label": 'V10供货商J', "class": 'type-queue'},
    {"id": 11, "label": 'V11供货商K', "class": 'type-run'},
    {"id": 12, "label": 'V12特仑苏工厂', "class": 'type-suss'},
    {"id": 14, "label": 'V14酸酸乳工厂', "class": 'type-fail'},
    {"id": 15, "label": 'V15新养道工厂', "class": 'type-freeze'},
    {"id": 16, "label": 'V16蒙牛制造总部', "class": 'type-suss'},
    {"id": 17, "label": 'V17蒙牛行销总部', "class": 'type-queue'},
    {"id": 18, "label": 'V18北京分公司', "class": 'type-run'},
    {"id": 19, "label": 'V19武汉分公司', "class": 'type-suss'},
    {"id": 20, "label": 'V20温州分公司', "class": 'type-init'},
    {"id": 21, "label": 'V21卖场A', "class": 'type-fail'},
    {"id": 22, "label": 'V22卖场B', "class": 'type-fail'},
    {"id": 23, "label": 'V23卖场C', "class": 'type-fail'},
    {"id": 24, "label": 'V24卖场D', "class": 'type-fail'},
    {"id": 25, "label": 'V25卖场E', "class": 'type-fail'},
    {"id": 26, "label": 'V26客户A', "class": 'type-run'},
    {"id": 27, "label": 'V27客户B', "class": 'type-run'},
    {"id": 28, "label": 'V28客户C', "class": 'type-run'},
    {"id": 29, "label": 'V29客户D', "class": 'type-run'},
    {"id": 30, "label": 'V30客户E', "class": 'type-run'},
    {"id": 31, "label": 'V31客户F', "class": 'type-run'},
    {"id": 32, "label": 'V32客户G', "class": 'type-run'},
    {"id": 33, "label": 'V33客户H', "class": 'type-run'},
    {"id": 34, "label": 'V34客户I', "class": 'type-run'}
]
